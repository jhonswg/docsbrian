...
export const WardenHorizontalNav = () => {
  ...
  const menuItems = [
    {
      icon: "🏠",
      label: "Introduction",
      path: "/services/testnet/warden/",
    },
    {
      icon: "⚙️",
      label: "Public Endpoint",
      path: "/services/testnet/warden/public-endpoint",
      submenu: [
        {
          label: "📡 RPC, API & gRPC",
          path: "/services/testnet/warden/public-endpoint",
    ...
    },
    {
      ...
      submenu: [
        {
          label: "🔧 Install Node",
          path: "/services/testnet/warden/installation",
        },
        {
          label: "💰 Token Management",
          path: "/services/testnet/warden/token-management",
        },
        {
          label: "👨‍💼 Validator Management",
          path: "/services/testnet/warden/validator-management",
        },
      ],
    },
    {
      icon: "🔄",
      label: "Upgrade",
      path: "/services/testnet/warden/upgrade",
    },
    {
      icon: "📝",
      label: "Cheat Sheet",
      path: "/services/testnet/warden/cheat-sheet",
    },
    {
      icon: "🌐",
      label: "Decentralization Analytics",
      path: "/services/testnet/warden/decanaly",
    },
    {
      icon: "🙏",
      label: "Consensus",
      path: "/services/testnet/warden/consensus",
    },
    {
      icon: "🛰️",
      label: "Public RPC Scanner",
      path: "/services/testnet/warden/rpcscanner",
    },
    {
      icon: "🤖",
      label: "Proposal Bot",
      path: "/services/testnet/warden/proposalbot",
    },
  ];
