...
export const SymphonyHorizontalNav = () => {
  ...
  const menuItems = [
    {
      icon: "🏠",
      label: "Introduction",
      path: "/services/testnet/symphony/",
    },
    {
      icon: "⚙️",
      label: "Public Endpoint",
      path: "/services/testnet/symphony/public-endpoint",
      submenu: [
        {
          label: "📡 RPC, API & gRPC",
          path: "/services/testnet/symphony/public-endpoint",
    ...
    },
    {
      ...
      submenu: [
        {
          label: "🔧 Install Node",
          path: "/services/testnet/symphony/installation",
        },
        {
          label: "💰 Token Management",
          path: "/services/testnet/symphony/token-management",
        },
        {
          label: "👨‍💼 Validator Management",
          path: "/services/testnet/symphony/validator-management",
        },
      ],
    },
    {
      icon: "🔄",
      label: "Upgrade",
      path: "/services/testnet/symphony/upgrade",
    },
    {
      icon: "📝",
      label: "Cheat Sheet",
      path: "/services/testnet/symphony/cheat-sheet",
    },
    {
      icon: "🌐",
      label: "Decentralization Analytics",
      path: "/services/testnet/symphony/decanaly",
    },
    {
      icon: "🙏",
      label: "Consensus",
      path: "/services/testnet/symphony/consensus",
    },
    {
      icon: "🛰️",
      label: "Public RPC Scanner",
      path: "/services/testnet/symphony/rpcscanner",
    },
    {
      icon: "🤖",
      label: "Proposal Bot",
      path: "/services/testnet/symphony/proposalbot",
    },
  ];
