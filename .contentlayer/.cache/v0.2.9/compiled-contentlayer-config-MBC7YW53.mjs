...
var githubBaseUrl = "https://github.com/bryanbarrios/lil-docs-template";
var siteConfig = {
  repo: {
    url: githubBaseUrl,
  ...
  seo: {
    ...
    openGraph: {
      ...
      type: "website",
      image: {
        url: `${websiteUrl}/public/logo/logo.png`,
        width: 1240,
        height: 480,
    ...
    twitter: {
      ...
      image: {
        url: `${websiteUrl}/publix/images/banner.png`,
        width: 1012,
        height: 506,
        alt: "Lil Documentation Template: A lil docs template for lil projects.",
        type: "image/png"
...
//# sourceMappingURL=compiled-contentlayer-config-MBC7YW53.mjs.map
