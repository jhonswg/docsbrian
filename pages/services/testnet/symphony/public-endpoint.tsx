...
export default function PublicEndpointPage() {
  ...
  return (
    <>
      ...
      <SymphonyLayout>
          ...
          {[
            {
              title: "RPC, API, gRPC",
              items: [
                { label: "RPC", value: "https://symphonyd-testnet-rpc.itrocket.net" },
                { label: "API", value: "https://symphonyd-testnet-api.itrocket.net" },
                { label: "gRPC", value: "symphonyd-testnet-grpc.itrocket.net:443" },
              ],
            },
            {
              title: "Peers & Seeds",
        ...
        <Button mt={8} as={ChakraLink} href="/symphony" variant="ghost" colorScheme="orange" size="sm">
          ← Back to Overview
        </Button>
      </SymphonyLayout>
    </>
