...
export default function InitiaInstallationPage() {
  return (
    <>
      <Head>
        <title>Initia - Installation</title>
        <meta
          name="description"
          content="Initia Installation Guide"
        />
      </Head>
...
`}
          ...
          <Box>
            ...
            <CodeBlock
              code={`git clone https://github.com/initia-labs/initia.git
cd initia
...
`}
          ...
          <Box>
            ...
            <CodeBlock
              code={`echo 'export MONIKER="My_Node"' >> ~/.bash_profile
...
`}
          ...
          <Box>
            ...
            <CodeBlock
              code={`wget https://initia.s3.ap-southeast-1.amazonaws.com/initiation-1/genesis.json -O $HOME/.initia/config/genesis.json
`}
            />
          </Box>
...
`}
          ...
          <Box>
            ...
            <CodeBlock
              code={`sudo tee /etc/systemd/system/initiad.service > /dev/null <<EOF
[Unit]
...
`}
          ...
          <Box>
            ...
            <CodeBlock 
            code={`sudo journalctl -u initiad -f -o cat
`} />
          </Box>
        </VStack>
